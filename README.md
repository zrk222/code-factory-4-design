...
Prestige consumes the enforceable token groups from the upstream alpha
[`DESIGN.md` YAML-front-matter format](https://github.com/google-labs-code/design.md)
...
```bash
prestige tokens init                         # writes an upstream-shaped DESIGN.md
prestige tokens lint page.html --strict      # blocks OFF_TOKEN, CONTRACT_MISSING, or CONTRACT_INVALID
